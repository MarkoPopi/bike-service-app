...
/* ===================== HOME: STRANKE ===================== */
function CustomersPanel(props: { customers: Customer[]; onAdd: (c: Customer) => void; onCustomerClick: (id: string) => void }) {
  const PLACEHOLDER = "Iskanje…";
  const [q, setQ] = React.useState<string>(PLACEHOLDER);
...
function SuspensionTableNoScroll(props: { items: SuspensionEntry[]; onDelete: (id: string) => void }) {
  ...
  // 12 stolpcev, brez horizontal scrolla: vse je fr in se prilagaja
  const cols =
    "0.9fr 1.2fr 1.2fr 0.6fr 0.7fr 0.5fr 0.5fr 0.5fr 0.5fr 1.0fr 1.2fr 56px";
...
/* ===================== SEATPOST: VNOS + TABELA (ENAK “EXCEL” VIDEZ) ===================== */
...
/* ===================== KOLO: VNOS + TABELA (ENAK VIDEZ, NO H-SCROLL) ===================== */
